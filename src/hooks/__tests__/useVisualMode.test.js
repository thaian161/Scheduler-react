...
//BACK LIMITED: This test will confirm that navigating back from the initial mode will not change the mode value.
...
//TRANSITION WITH REPLACE: The test below shows that calling back will skip the SECOND mode.
